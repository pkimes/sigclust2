...
#' @slot eigval_sim a matrix containing the estimated eigenvalues used for
#'       testing at each subtree tested along the dendrogram
#' @slot backvar a vector containing the 
